...
public class ParamPattern {
    ...
    public static final String NETWORK_NAME_REGEX = "^[A-Za-z][A-Za-z0-9]{3,}$";
    public static final String NETWORK_NAME_MSG = "网络名称长度至少为4，只能由字母和数字组成";

    public static final String CONSORTIUM_NAME_REGEX = "^[A-Za-z][A-Za-z0-9]{3,}$";
    public static final String CONSORTIUM_NAME_MSG = "联盟名称长度至少为4，只能由字母和数字组成";

    public static final String ORGANIZATION_NAME_REGEX = "^[A-Za-z]{4,}$";
    ...
    public static final String API_SERVER_REGEX = "^((?!-)[A-Za-z0-9-]{1,63}(?<!-)\\.)+[A-Za-z]{2,6}:[1-9][0-9]+$";
